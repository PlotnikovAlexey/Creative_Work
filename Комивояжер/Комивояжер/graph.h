...
int Graph<T>::Dijkstra(T& startVertex)
{
	...
	{
		cout << "Кратчайшее расстояние от пункта " << startVertex << " до пункта " << vertList[i] << " равно " << labelList[GetVertPos(vertList[i])] << endl;
	}
...
void Graph<T>::InsertEdge(const T& vertex1, const T& vertex2, int weight)
{
	if (this->GetVertPos(vertex1) != (-1) && this->GetVertPos(vertex2) != (-1))
	{
		...
		{
			cout << "Путь между пунктами уже есть" << endl;
			return;
		}
		else
		{
	...
	{
		cout << "Одного из населённых пунктов(или обоих) нет в графе " << endl;
		return;
	}
}
...
void Graph<T>::Print()
{
	if (!this->IsEmpty())
	{
		...
		T startVertex;
		cout << "Введите начальный населённый пункт: ";
		cin >> startVertex;
		cout << endl;
...
void Graph<T>::InsertVertex(const T& vertex)
{
	...
	{
		cout << "Граф уже заполнен. Невозможно добавить новый населённый пункт " << endl;
		return;
	}
}
...
Graph<int> makeGraph()
{
	...
	cout << "Введите количество населённых пунктов: "; cin >> amountVerts; cout << endl;
	...
	{
		cout << "Исходный населённый пункт: "; cin >> sourceVertex; cout << endl;
		int* sourceVertPtr = &sourceVertex;
		cout << "Конечный населённый пункт: "; cin >> targetVertex; cout << endl;
